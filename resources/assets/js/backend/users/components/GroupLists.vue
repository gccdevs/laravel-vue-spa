    ...
    <div class="component-wrap">
        ...
        <v-card>
            <v-layout row wrap>
                <v-flex xs12 class="px-2 pt-2">
                    <v-btn @click="$router.push({name:'users.groups.create'})" class="blue lighten-1">
                        New Group
        ...
        <v-data-table
            ...
            <template slot="items" slot-scope="props">
                ...
                <td>
                    <v-btn small @click="showDialog('group_permissions',props.item.permissions)" outline round color="grey">Show</v-btn>
                </td>
