        ...
        <v-card>
            ...
            <v-form v-model="valid" ref="userFormEdit" lazy-validation>
                ...
                <v-layout row wrap>
                    ...
                    <v-flex xs12 sm4>
                        <v-btn @click="addSpecialPermission()" class="blue lighten-1">
                            Add Permission
                    ...
                    <v-flex xs12>
                        <div class="permissions_container">
                            <v-chip v-for="(p,k) in permissions" :key="k" @input="removePermission(k)" close class="white--text" :class="{'green':(p.value==1),'red':(p.value==-1),'blue':(p.value==0)}">
                                <v-avatar v-if="p.value==-1" class="red" title="Deny">
                                    <v-icon>block</v-icon>
                                </v-avatar>
                                <v-avatar v-if="p.value==1" class="green" title="Allow">
                                    <v-icon>check_circle</v-icon>
                                </v-avatar>
                                <v-avatar v-if="p.value==0" class="blue" title="Inherit">
                    ...
                    <v-flex xs12>
                        <v-btn @click="save()" :disabled="!valid" color="primary">Update</v-btn>
                    </v-flex>
                </v-layout>
            </v-container>
            </v-form>
